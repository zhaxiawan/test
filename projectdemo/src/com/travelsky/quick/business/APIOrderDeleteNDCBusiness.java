...
/**
 * @author 作者:WWH
 * @version 0.1 类说明: 订单删除接口
 *
 */
@Service("LCC_ORDERDELETE_SERVICE")
public class APIOrderDeleteNDCBusiness extends AbstractService<ApiContext> {
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(APIOrderDeleteNDCBusiness.class);
	...
	public CommandRet getResponseBean() {
		...
		return orderOpManager.orderDelete(input, context);
	}
